                    ...
                    <!-- <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{url('/estudiantes/create')}}" class="btn btn-primary">
                                <i class="bi bi-file-plus"></i>Agregar Estudiante
                            </a>
                        </div>
                    </div> -->
                                ...
                                <form action="{{url('estudiantes')}}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="number" name="edad" value="{{old('edad')}}" class="form-control" onkeypress="return event.charCode >= 48" min="20" placeholder="mayor o igual a 20" required>
                                            @error('edad')
                                            <small style="color: red">Este campo es requerido</small>
                                            @enderror
                                            </div>
                            ...
                            <tr>
                                <td style="text-align: center">{{$contador}}</td>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{route('estudiantes.show',$estudiante->id)}}" type="button" class="btn btn-info">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{route('estudiantes.edit',$estudiante->id)}}" type="button" class="btn btn-success"><i class="bi bi-pencil"></i></a>
                                        <form action="{{route('estudiantes.destroy',$estudiante->id)}}" onclick="preguntar<?=$id;?>(event)" 
