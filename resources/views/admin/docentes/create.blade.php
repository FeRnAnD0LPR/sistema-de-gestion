                ...
                <div class="card card-outline card.primary">
                    ...
                    <div class="card-body" style="display: block;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Formación profesional</label>
                                    <input type="file" name="formacion_profecional" value="{{old('formacion_profecional')}}" class="form-control" required>
                                    @error('formacion_profecional')
                                    <small style="color: red">Este campo es requerido</small>
                                    @enderror
                                </div>
                            </div>
